        ...
        <div className="page">
            ...
            <div className="topic">
                ...
                <p>I choose not to use social media because it's a personal preference. I find that I'm more content and focused without it. 
                    ...
                    However, I do have a <a className="link" href="https://linkedin.com/in/david-martinez-a51b78205/">LinkedIn</a> profile that I use to connect with people in a professional setting.
                </p>
            </div>
        </div>
    )
